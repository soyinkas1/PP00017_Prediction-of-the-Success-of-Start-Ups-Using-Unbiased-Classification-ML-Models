# PP00017-Prediction of the Success of Start-Ups Using Classification ML Models
    
**Problem Statement:** The need to make investment funds available to more companies by adequately predicting their success based on separate characteristics (parameters)
...
14. [Future Planned Updates](#Future-Planned-Updates)


## Project Overview
This project involves building an end-to-end machine learning classification model to predict a company's success given information about the company and its main promoter.

This is an updated version of the initial M.Sc research work from which 2,000,000+ company data sourced from Crunchbase were used to train classification models to predict successful companies based on selected criteria that are indications of a successful company. 

The research outcome was good -it was graded an A by Cardiff Metropolitan University. There was the need to extend it further to a production-grade application, thus the current key objectives were defined.

**Current Objectives**
* Enhance the approach used in the initial research
