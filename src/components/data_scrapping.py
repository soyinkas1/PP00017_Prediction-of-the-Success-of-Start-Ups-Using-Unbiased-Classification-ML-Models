...
class DataScrapping:
    ...
    def twitter_data_scrapping(self):
        ...
        def get_tweets(element):
            logging.info("Twitter scrapping ongoing......")
            # global views_data
            time.sleep(5)
            try:
        ...
        for twitter_page in social_df[self.scrapping_config.twitter_url]:
            ...
            try:
                ...
                try:
                    ...
                    time.sleep(5)  # this time might vary depending on your computer
                ...
                username.send_keys(self.scrapping_config.username)  # Write Email Here
                ...
                password.send_keys(self.scrapping_config.password)  # Write Password Here
        ...
        logging.info("Twitter scrapping completed......")
...
# Scrape Facebook
    ...
    def facebook_data_scrapping(self):
       ...
       # Import the dataset containing the twitter accounts to scrape
        ...
        # search_box.send_Keys(Keys.ENTER)
        # Scrape the twitter accounts in a loop
        for facebook_page in social_df[self.scrapping_config.facebook_url]:
